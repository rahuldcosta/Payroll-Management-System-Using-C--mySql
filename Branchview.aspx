<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Branchview.aspx.cs" Inherits="Branchview" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    PostBackUrl="~/Branches.aspx" Text="Add Branch" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button3" runat="server" CausesValidation="False" 
    PostBackUrl="~/updateBranch.aspx" Text="Update Branch" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button4" runat="server" 
    Text="Delete Branch" CausesValidation="False" onclick="Button4_Click" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button6" runat="server" CausesValidation="False" 
        onclick="Button6_Click" Text="Employees in Branch" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;<asp:MultiView ID="MultiView1" runat="server" 
        ...
        <asp:View ID="View1" runat="server">
            <br />
            Branch Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:DropDownList ID="DropDownList1" runat="server" Height="38px" Width="140px" 
        ...
        <asp:View ID="View2" runat="server">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:DropDownList ID="idtxtbox" runat="server" 
                DataSourceID="SqlDataSource3" DataTextField="bname" DataValueField="bid" 
                onselectedindexchanged="idtxtbox_SelectedIndexChanged">
            </asp:DropDownList>
            ...
            <br />
             ...
             <asp:View ID="View3" runat="server">
                 <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" 
                     ...
                     CellPadding="3" CellSpacing="2" DataKeyNames="Employee_id">
                 ...
                 <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                     ...
                     SelectCommand="SELECT Employee.Name, Employee.Employee_id, Employee.Designation, DEPT.dname, Employee.Employee_Type, Employee.Lastname FROM DEPT INNER JOIN Employee ON DEPT.deptid = Employee.deptid WHERE (Employee.bid = @bid)">
                     <SelectParameters>
